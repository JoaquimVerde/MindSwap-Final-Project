...
const Sidenav: React.FC<SidenavProps> = ({ isHidden, onHide }) => {
  return (
    <div className={`drawer ${isHidden ? "hidden" : "lg:drawer-open"}`}>
      ...
      <div className="drawer-content flex flex-row items-start justify-start ml-5 mt-5 "></div>
      <div className="drawer-side">
        ...
        ></label>
        <ul className="menu p-4 w-86 min-h-full allThePurple text-sm font-medium text-white">
