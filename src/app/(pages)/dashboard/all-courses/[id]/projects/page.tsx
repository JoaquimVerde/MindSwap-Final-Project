                        ...
                        <div>
                            <Card className={cn("w-[380px] mx-4 my-4")}>
                                ...
                                <CardContent className="grid gap-4">
                                    <div className=" flex items-center space--4 rounded-md border border-accent p-4">
                                ...
                                <Dialog>
                                    <DialogTrigger asChild>
                                        <div>
                                        <Button  className="bg-primary ml-7 w-80 flex justify-center items-center p-0 pt-0 mb-5 ">
                                    ...
                                    <DialogContent className="sm:max-w-[425px]">
                                        ...
                                        <DialogFooter>
                                        <Button className="bg-primary" type="submit" onClick={() => handleUpdateGrade(project.id.replace("#", "%23"))}>
                                        Save
                                        </Button>
                                        </DialogFooter>
                                    </DialogContent>
